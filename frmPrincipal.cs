...
namespace RPSuite
{
    public partial class frmPrincipal : DevExpress.XtraBars.Ribbon.RibbonForm, IMessageFilter
    {
        ...
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoCliente", this);
            bvcMenuPrincipal.Close();
        }

        private void bvcMenuPrincipal_Click(object sender, EventArgs e)
        {
        ...
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoFormaCompra", this);
            bvcMenuPrincipal.Close();
        }

        private void tileItem33_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoGrupoFactura", this);
            bvcMenuPrincipal.Close();
        }

        private void tileItem34_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoGasolinero", this);
            bvcMenuPrincipal.Close();
        }
...
<<<<<<< HEAD
        ...
        private void timEntregarPremio_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
